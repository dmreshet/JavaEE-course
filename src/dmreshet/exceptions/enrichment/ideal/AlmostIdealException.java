...
public class AlmostIdealException {
}


class IdealEnrichableException extends RuntimeException {
    ...
    public IdealEnrichableException(String errorContext, String errorCode,
                               String errorMessage) {
    ...
    public IdealEnrichableException addInfo(
